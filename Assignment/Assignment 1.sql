...
--q9 y to find customers who have purchased a specific electronic gadget
DECLARE @ProductName VARCHAR(100) = 'Mouse';
...
DECLARE @CustomerID INT = 1; --  parameter for unknown value
...
--q9 to calculate the average order value (total revenue divided by the number of orders) for all customers. 
